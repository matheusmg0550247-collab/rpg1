...
def cube_html(label: str, height: int = 220) -> str:
    """Um 'dado 3D' visual (CSS cube). Não é física real: é animação + resultado vindo do Python."""
...
<style>
  ...
  .scene {{
    width:120px; height:120px; perspective:600px;
  }}
  .cube {{
  ...
  .face {{
    position:absolute; width:120px; height:120px; display:flex;
